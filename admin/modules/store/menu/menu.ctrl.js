(function() {
    ...
    function MenuController(Core,MENU_CONSTANT,$stateParams) {
        ...
        function __construct() {
            ...
            vm.query = '';
            vm.comment = {};
            vm.moduleApiMenuUrl = Core.$rootScope.serverApiUrl + MENU_CONSTANT.MODULE_MENU_URL;
            vm.moduleApiFoodUrl = Core.$rootScope.serverApiUrl + MENU_CONSTANT.MODULE_FOOD_URL;
        ...
        */
        ...
        vm.deleteMenu = function(menu){
            Core.sweetAlertHandle(MENU_CONSTANT.DO_YOU_WANT_REMOVE_THIS_MENU).then(function(){
                var index = vm.listMenuActive.indexOf(menu);
                vm.menu = menu;
        ...
        */
                ...
                resolve: {
                        ...
                        load: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                ...
                                files: [
                                    'modules/store/menu/food/food.ctrl.js',
                                    'modules/store/menu/food/food.const.js',
                                ]
                            });
                        }]
                    }
        ...
        vm.destroyThisFood = function(food,type) {
            var index = vm.thisMenu.listFood.indexOf(food);
            Core.sweetAlertHandle(MENU_CONSTANT.DO_YOU_WANT_REMOVE_THIS_FOOD).then(function(){
        ...
        */
        ...
        vm.destroyComment = function(comment_index, comment) {
            Core.sweetAlertHandle(MENU_CONSTANT.DO_YOU_WANT_REMOVE_THIS_COMMENT).then(function(){
