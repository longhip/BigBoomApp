...
(function() {
    ...
    function ArticleController(Core,$stateParams) {
        ...
        function __construct() {
            ...
            vm.query = '';
            vm.comment = {};
            vm.moduleApiUrl = Core.$rootScope.serverApiUrl + 'store/article';
        ...
        vm.destroy = function(article,type) {
            Core.sweetAlertHandle('LABEL.DO_YOU_WANT_REMOVE_THIS_ARTICLE').then(function(){
